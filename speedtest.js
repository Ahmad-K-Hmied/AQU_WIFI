...
Speedtest.prototype = {
  ...
  setParameter: function(parameter, value) {
    ...
    if(parameter === "telemetry_location"){
        this._originalLocation=this._settings.telemetry_location;
    }
  },
  /**
  ...
  start: function() {
    ...
    if (this._state == 2) {
      ...
      if (typeof this._originalLocation !== "undefined") {
        this._settings.telemetry_location = JSON.stringify({
          server: this._selectedServer.name,
          location: this._originalLocation
        });
      } else
        this._settings.telemetry_location = JSON.stringify({
          server: this._selectedServer.name
