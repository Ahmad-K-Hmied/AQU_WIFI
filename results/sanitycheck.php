...
<?php
	$ip = getClientIp();
	$ispinfo="";
	$location='{"DBTest":"This is a simple test of the database.  No speed test was done."}';
	...
	$insertResult = insertSpeedtestUser($ip, $ispinfo, $location, $ua, $lang, $dl, $ul, $ping, $jitter, $log, true);
